...
function _renderDetail(id) {
  ...
  const editForm = `
    <div class="form-grid" style="margin-bottom:14px">
      ...
      <div class="form-field"><label class="form-label">TF Alignment</label><select class="form-select" id="e-tf" onchange="_handleCustomSelect(this,'e-tf-custom')"><option${t.tf === '30m > 3m' ? ' selected' : ''}>30m > 3m</option><option${t.tf === '1h > 5m' ? ' selected' : ''}>1h > 5m</option><option${t.tf === '1h > 3m' ? ' selected' : ''}>1h > 3m</option><option${t.tf === '4h > 15m' ? ' selected' : ''}>4h > 15m</option><option${t.tf === '15m > 3m' ? ' selected' : ''}>15m > 3m</option><option value="__custom__">＋ Custom…</option></select><input type="text" class="form-input" id="e-tf-custom" placeholder="e.g. 2h > 5m" style="display:none;margin-top:6px" value="${['4h > 15m', '1h > 5m', '1h > 3m', '30m > 3m', '15m > 3m', '15m > 1m'].includes(t.tf) ? '' : t.tf}"></div>
    </div>
...
function openModal(prefill) {
  ...
  document.getElementById('m-tf').value = '4h > 15m';
...
function buildEntryForm() {
  document.getElementById('entry-form-content').innerHTML = `
    <div class="form-grid">
      ...
      <div class="form-field"><label class="form-label">TF Alignment</label><select class="form-select"><option>4h > 15m</option><option>1h > 5m</option><option>1h > 3m</option><option>30m > 3m</option><option>15m > 3m</option><option>15m > 1m</option><option value="__custom__">＋ Custom…</option></select></div>
