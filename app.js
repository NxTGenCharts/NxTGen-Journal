...
function buildEntryForm() {
  document.getElementById('entry-form-content').innerHTML = `
    <div class="form-grid">
      ...
      <div class="form-field"><label class="form-label">TF Alignment</label><select class="form-select"><option>30m > 3m</option><option>1h > 5m</option><option>1h > 3m</option><option>4h > 15m</option><option>4h > 5m</option><option>4h > 3m</option><option>15m > 3m</option><option value="__custom__">＋ Custom…</option></select></div>
